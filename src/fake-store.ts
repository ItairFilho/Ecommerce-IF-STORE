...
REQUISITOS TÉCNICOS: 
    ...
    - DUAS ROTAS: list, cart

----------------------------------

EU COMO USUÁRIO QUERO... 

    - VER A LISTA DE PRODUTOS NA TELA, SEM PAGINAÇÃO.
    - VER A NOTA DO PRODUTO
    - TER A OPÇÃO DE FILTRAR OS PRODUTOS POR CATEGORIAS.
    - PODER ADICIONAR OS PRODUTOS NO CARRINHO.
    - AO VOLTAR PARA O SITE OS ITENS CONTINUAREM NO CARRINHO. (localStorage)
    - EXCLUIR PRODUTOS DO CARRINHO.
    - PODE AUMENTAR PELO CARRINHO A QUANTIDADE DE PRODUTOS QUE ESTOU COMPRANDO.
